        ...
        <div>
            <div class="d-flex flex-column flex-shrink-0 bg-black" style="width: 4.5rem;">
                ...
                <ul class="nav nav-pills nav-flush flex-column mb-auto text-center my-4">
                    ...
                    <li>
                        <a href="#" class="nav-link active py-3 my-3 bg-warning" title="" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Orders">
                    ...
                    <div class="container-fluid d-flex justify-content-center my-4">
                        <div class="w-75">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <button type="button">Criar Serviço</button>
                                </div>
                                <div>
                    ...
                    <div class="container-fluid d-flex justify-content-center my-4">
                        <div class="w-75">
                            <table class="bg-light w-100">
                                <tr>
                                    <th id="tb-modelo">Modelo</th>
                                    <th id="tb-placa">Placa</th>
                                    <th id="tb-os">O.S.</th>
                                    <th id="tb-status">Status</th>
                                    <th id="tb-btn"></th>
                                </tr>
                            </table>
                        </div>
